...
class TestAuthentication:
    def test_session_auth_priority(self, auth_client):
        """
        ...
        # Since we use allauth headless, user_me might not be registered or named differently
        # Let's check common endpoints or fallback to a simple verification

    def test_jwt_auth_bearer(self, jwt_auth_client):
        """
...
class TestUserProfile:
    ...
    def test_update_profile_authenticated(self, auth_client, test_user):
        """
